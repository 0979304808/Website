                    ...
                    <div class="x_content">
                        <div class="text-editor">
                            ...
                            <div class="col-xs-11">
                                    ...
                                    <div class="form-group ">
                                        <select name="account" id="" class="form-control">
                                            @foreach ($accounts as $key => $value)
                                                <option value="{{ $value->userId }}" @if(request('account') == $value->userId ) selected @endif >{{ $value->username }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <input type="text" name="link" class="form-control" placeholder="Nguồn">
                                </div>
                                @include('backend.includes.editor', ['id' => 'post', 'type' => 'post', 'height' => 60])
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <ul class="nav navbar-right panel_toolbox">
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                <li><a href="" class="btn btn-edit-post" data-id="{{ $post->id }}" data-toggle="modal" data-target=".bs-modal-edit-post-{{$post->id}}">Edit</a></li>
                                                <li><a href=";" class="btn btn-delete-post" data-id="{{ $post->id }}">Delete</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </div>
        ...
        <div class="col-xs-3">
            <div class="x_panel">
                @foreach ($posts as $post)
                    <div class="x_title">
                        <a href="{{ route('backend.social.post.detail', ['post' => $post->id, 'lang' => request('lang')]) }}">{{ $post->title }}</a>
                    </div>
                @endforeach
            </div>
        </div>
